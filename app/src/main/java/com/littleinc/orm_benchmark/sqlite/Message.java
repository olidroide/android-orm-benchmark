...
public class Message {
  ...
  public static final String[] PROJECTION = new String[] {
      CONTENT, SORTED_BY, CLIENT_ID, SENDER_ID, CHANNEL_ID, COMMAND_ID, CREATED_AT
  };
  ...
  public static void createTable(DataBaseHelper helper) {
    ...
    db.execSQL(new StringBuilder("CREATE INDEX IDX_MESSAGE_COMMAND_ID ON ").append(TABLE_NAME)
        .append(" (")
        .append(COMMAND_ID)
        .append(");")
        .toString());
